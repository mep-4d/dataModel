...
<ul>
  <li><strong>SubItem:</strong> shall be a string descriptor that represents a component of the asset. The string shall use camel case if made up of a maximum three words (a,b,c) which shall be as follows;</li>
</ul>
